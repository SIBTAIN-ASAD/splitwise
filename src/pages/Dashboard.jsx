      ...
      <div className='w-full md:w-3/4 flex flex-col md:flex-row gap-10'>
        {currentUser && (
          ...
          <div className='flex flex-col'>
            ...
            <button type="button" class="text-white bg-[#2eaec5] hover:bg-[#2eaec5]/80 focus:ring-4 focus:outline-none focus:ring-[#2eaec5]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#2eaec9]/80 dark:focus:ring-[#2eaec9]/40 me-2 mb-2"
